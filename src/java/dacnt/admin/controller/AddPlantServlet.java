 ...
 * @author Daniel NG
 */
@WebServlet(name = "AddPlantServlet", urlPatterns = {"/AddPlantServlet"})
public class AddPlantServlet extends HttpServlet {

    private final String ADD_PLANT_PAGE = "AdminController?action=addPlant";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (txtPlantName.isEmpty() || (category > 3 || category < 1)
