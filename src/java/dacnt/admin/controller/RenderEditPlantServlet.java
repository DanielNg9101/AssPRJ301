 ...
 * @author Daniel NG
 */
@WebServlet(name = "RenderEditPlantServlet", urlPatterns = {"/RenderEditPlantServlet"})
public class RenderEditPlantServlet extends HttpServlet {

    private final String EDIT_PLANT_PAGE_URL = "AdminController?action=editPlant&doAction=tranferToEditPage";
